...
//@ + `silent`: Do not echo program output to qa-tools.
//@
//@ Examples:
//@
//@ ```javascript
...
//@   qa-tools.log('Exit code:', code);
//@   qa-tools.log('Program output:', output);
//@ });
//@ ```
//@
...
// Wrapper around exec() to enable echoing output to qa-tools in real time
